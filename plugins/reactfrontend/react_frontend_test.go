...
`
		...
		It("forges files", func() {
			...
			Expect(dummyWriter).Should(forgeio.ContainFiles(
				...
				"apps/frontend/app/(account)/components/buttons/tertiaryButton.tsx",
				...
				"apps/frontend/app/(account)/components/buttons/primaryButton.tsx",
				...
				"apps/frontend/app/(account)/components/buttons/secondaryButton.tsx",
